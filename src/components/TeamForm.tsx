    ...
    return (
        ...
        >
            <motion.div
                ...
                className="w-full max-w-md p-8 space-y-8 relative rounded-[32px] border border-white/10 backdrop-blur-xl shadow-2xl"
            ...
            >
                ...
                <div className="text-center space-y-4">
                    ...
                    <div>
                        <h2 className="text-2xl font-black text-white tracking-tight">Nouvelle <span className="text-[var(--accent-tan)]">Équipe</span></h2>
                        <p className="text-[var(--text-secondary)] text-sm mt-2">Créez un espace collaboratif pour vos projets.</p>
                    </div>
                </div>
